...
import { NAV_ITEMS, SITE_CONFIG, FEATURES } from "@/lib/constants";
          ...
          <div className="relative flex items-center justify-between">
            ...
            >
              <span className="tracking-tight text-white">
                <span className="text-2xl font-bold">李世豪</span>
            ...
            {/* 简历按钮：由 constants.ts 里的 FEATURES.showResumeButton 控制开关 */}
            {FEATURES.showResumeButton && (
              ...
              <Sheet open={open} onOpenChange={setOpen}>
                ...
                >
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    {/* 简历按钮：同样由 FEATURES.showResumeButton 控制 */}
                    {FEATURES.showResumeButton && (
